...
public class booking_Multiple_seat {
    ...
    void select() throws IOException, InterruptedException {
        driver.findElement(By.xpath("/html/body/div[1]/div[3]/div/div[2]/div[2]/div[2]/div/div/div[2]/div[2]/div/a")).click();
    }
    ...
    void select_Seat() throws IOException, InterruptedException {
        ...
        //1st
        driver.findElement(By.xpath("/html/body/div[1]/div[3]/div/div[2]/div[1]/div/div[1]/div[2]/fieldset/div[1]/div/div[2]/div[1]/div[1]/span")).click();
        Thread.sleep(1000);
        ...
        driver.findElement(By.xpath("/html/body/div[1]/div[3]/div/div[2]/div[1]/div/div[1]/div[2]/fieldset/div[1]/div/div[4]/div[1]/div[1]/span")).click();
        Thread.sleep(1000);
        driver.findElement(By.xpath("/html/body/div[1]/div[6]/div/div/div[2]/fieldset/div[1]/label[1]")).click();
        Thread.sleep(1000);
        driver.findElement(By.xpath("//*[@id=\"selectGenderSeat\"]")).click();
        Thread.sleep(1000);
